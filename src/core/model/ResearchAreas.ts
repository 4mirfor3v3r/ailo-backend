class ResearchArea {
    ...
    constructor(research_area_id: number, research_area_name: string, research_area_short_name: string, research_area_description: string, research_area_icon: string, research_area_image: string) {
